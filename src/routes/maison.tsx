...
export const Route = createFileRoute("/maison")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://peuujewels.in/maison" },
      { property: "twitter:image", content: "https://peuujewels.in/ring.jpeg" },
    ],
    links: [{ rel: "canonical", href: "https://peuujewels.in/maison" }],
  }),
    ...
    body: (
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Mrs. Archana Bhujbal & Mr. Ganesh Bhujbal — Our Founders & Pillars of Strength&nbsp;The backbone of this entire journey. Without their selfless support, constant sacrifices, and unwavering belief, PEUU Jewels would never have taken root, nor reached the heights it stands at today.
          </div>
        </div>
      </div>
    ),
